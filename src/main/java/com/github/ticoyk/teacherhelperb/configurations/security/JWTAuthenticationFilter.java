...
// It's a simple application with the objective of learning, that's why 
// there are no Privileges and I use a Empty ArrayList.
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        // Once Successful Create JWT Token
